    ...
    return (              
              ...
              <Card
                ...
                <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
                  <Avatar src='https://cdn.prod.website-files.com/647888ca92d03e3fca3f1ea0/647888ca92d03e3fca3f2459_waste-sorting-facility-management-control-2022-10-24-17-54-03-utc.jpeg' sx={{ '--Avatar-size': '4rem' }} />
                ...
                <CardOverflow sx={{ bgcolor: 'background.level1' }}>
                  <CardActions buttonFlex="1">
                    <ButtonGroup variant="outlined" sx={{ bgcolor: 'background.surface' }}>
                      <Button onClick={()=>onDeleteClick(company._id)}>Delete</Button>
                      
                    </ButtonGroup>

                    <Link className="btn btn-outline-warning float-right" to={`/companydetails/${company._id}`}>Details</Link>
